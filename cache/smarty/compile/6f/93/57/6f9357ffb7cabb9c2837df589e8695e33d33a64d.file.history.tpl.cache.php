<?php /* Smarty version Smarty-3.1.19, created on 2015-11-25 17:04:32
         compiled from "C:\xampp\htdocs\SupraShop\themes\default-bootstrap\history.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_565587b0a67091_90954408',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_565587b0a67091_90954408')) {function content_565587b0a67091_90954408($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include 'C:\\xampp\\htdocs\\SupraShop\\tools\\smarty\\plugins\\modifier.regex_replace.php';
?>
...
">
						...
						<td<?php if (isset($_smarty_tpl->tpl_vars['order']->value['order_state'])) {?> data-value="<?php echo $_smarty_tpl->tpl_vars['order']->value['current_state'];?>
...
">
							...
							<?php if (isset($_smarty_tpl->tpl_vars['order']->value['order_state'])) {?>
							<?php if ($_smarty_tpl->tpl_vars['order']->value['current_state']=='10') {?>
							<a class="btn btn-default button button-small" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getModuleLink('confirmpayment','confirmpayment',array(),true), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Confirm Payment','mod'=>'confirmpayment'),$_smarty_tpl);?>
">
								<span>
									<?php echo smartyTranslate(array('s'=>'Confirm'),$_smarty_tpl);?>
<i class="icon-chevron-right right"></i>
								</span>
							</a>
							<?php }?>
